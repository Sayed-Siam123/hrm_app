...
class _LeaveTabState extends State<LeaveTab> {
  List<LeaveType_Approve> fetcheddata = [];

  LeaveApprovalData approvedata;
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Container(
                ...
                color: Colors.white,
                child: StreamBuilder<List<LeaveType_Approve>>(
                  stream: approvalbloc.allLeaveApprovalData,
                  builder: (context,
                      AsyncSnapshot<List<LeaveType_Approve>> snapshot) {
                    if (snapshot.hasData) {
  ...
  Widget verticalList1(data) {
    return RefreshIndicator(
      ...
      onRefresh: (){
        return approvalbloc.fetchAllLeaveApprovaldata();
      },
      child: Container(
                                  ...
                                  ? Builder(
                                    builder: (context) => InkWell(
                                        ...
                                        onTap: () {
                                          ...
                                          approvalbloc.LeaveApprovalPost(approvedata);
                                          approvalbloc.fetchAllLeaveApprovaldata();
                                        },
                                      ),
                                  )
